...
public class PulseSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.bootleg_external_pulse_settings);
        ...
        mColorPickerPref.setDefaultValue(getContext().getResources().getColor(com.android.internal.R.color.accent_device_default));
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() {
        ...
        public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
            ...
            sir.xmlResId = R.xml.bootleg_external_pulse_settings;
            result.add(sir);
            return result;
        }
