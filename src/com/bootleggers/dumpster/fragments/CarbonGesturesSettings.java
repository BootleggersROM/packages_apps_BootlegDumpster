 ...
 */
 ...
 import com.bootleggers.dumpster.fragments.HAFRAppChooserAdapter.AppItem;
 import com.bootleggers.dumpster.fragments.HAFRAppChooserDialog;
 public class CarbonGesturesSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCarbonGestureFingers = (CustomSeekBarPreference) 
findPreference("carbon_gestures_fingers");
...
getActivity().getApplicationContext().getPackageManager();
        ...
        try {
            packageInfo = 
packageManager.getApplicationLabel(packageManager.getApplicationInfo(pkg, 
PackageManager.GET_META_DATA)).toString();
            } catch (PackageManager.NameNotFoundException e) {
                e.printStackTrace();
            }
        pref.setSummary(getActivity().getString(R.string.carbon_gesture_launch) + " " + 
packageInfo);
    }
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (preference.equals(mCarbonGestureFingers)) {
            Settings.System.putIntForUser(getContentResolver(),
                    Settings.System.CARBON_CUSTOM_GESTURE_FINGERS, (Integer) objValue, 
UserHandle.USER_CURRENT);
        ...
        if (preference.equals(mCarbonGestureRight)) {
            ...
            Settings.System.putIntForUser(getContentResolver(),
                    Settings.System.CARBON_CUSTOM_GESTURE_RIGHT, carbonGestureRight, 
UserHandle.USER_CURRENT);
            int index = mCarbonGestureRight.findIndexOfValue((String) objValue);
            if (carbonGestureRight == 1001) {
                launchAppChooseDialog(Settings.System.CARBON_CUSTOM_GESTURE_PACKAGE_RIGHT, 
mCarbonGestureRight);
            } else {
        ...
        if (preference.equals(mCarbonGestureLeft)) {
            ...
            Settings.System.putIntForUser(getContentResolver(),
                    Settings.System.CARBON_CUSTOM_GESTURE_LEFT, carbonGestureLeft, 
UserHandle.USER_CURRENT);
            int index = mCarbonGestureLeft.findIndexOfValue((String) objValue);
            if (carbonGestureLeft == 1001) {
                launchAppChooseDialog(Settings.System.CARBON_CUSTOM_GESTURE_PACKAGE_LEFT, 
mCarbonGestureLeft);
            } else {
        ...
        if (preference.equals(mCarbonGestureUp)) {
            ...
            Settings.System.putIntForUser(getContentResolver(),
                    Settings.System.CARBON_CUSTOM_GESTURE_UP, carbonGestureUp, 
UserHandle.USER_CURRENT);
            int index = mCarbonGestureUp.findIndexOfValue((String) objValue);
            if (carbonGestureUp == 1001) {
                launchAppChooseDialog(Settings.System.CARBON_CUSTOM_GESTURE_PACKAGE_UP, 
mCarbonGestureUp);
            } else {
        ...
        if (preference.equals(mCarbonGestureDown)) {
            ...
            Settings.System.putIntForUser(getContentResolver(),
                    Settings.System.CARBON_CUSTOM_GESTURE_DOWN, carbonGestureDown, 
UserHandle.USER_CURRENT);
            int index = mCarbonGestureDown.findIndexOfValue((String) objValue);
            if (carbonGestureDown == 1001) {
                launchAppChooseDialog(Settings.System.CARBON_CUSTOM_GESTURE_PACKAGE_DOWN, 
mCarbonGestureDown);
            } else {
