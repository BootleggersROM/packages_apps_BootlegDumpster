  ...
  public class HAFRAppListActivity extends Activity {
   ...
   /* others */
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        MenuItem add = menu.add(Menu.NONE, ID_ADD_APP, 0, 
R.string.hide_from_recents_add_app);
    ...
    public void removeApp(String pkg) {
        ...
        for (int i = 0; i < excludeFromRecentsList.size(); i++) {
            try {
                tempItemList2.add(new ArrayList<String>(Arrays.asList((String) 
packageManager.getApplicationLabel(packageManager.getApplicationInfo(excludeFromRecentsList.get(i), 
PackageManager.GET_META_DATA)), excludeFromRecentsList.get(i))));
